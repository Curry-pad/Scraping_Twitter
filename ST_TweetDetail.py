...
def TweetDetail(
  ...
  #2025/09/30　クエリID変更対応（レスポンスデータがでかいと文字化けする問題あり）
  #query_id = "JgryuItLZQ9V56vHjGIWWw"
  #少し古いクエリパラメータ
  query_id = "BbmLpxKh8rX8LNe2LhVujA"
  ...
  #2025/09/30　更新（レスポンスデータがでかいと文字化けする問題あり）
